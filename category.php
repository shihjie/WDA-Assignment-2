...
<?php
//all the $_GET['xxx_temp'] triggers where user click on one of the category in the navigation bar
$tempcatid;
if(isset($_GET['col_temp']))
{
$tempcatid=1;
}
if(isset($_GET['ele_temp']))
{
$tempcatid=2;
}
if(isset($_GET['ent_temp']))
{
$tempcatid=3;
}
if(isset($_GET['fas_temp']))
{
$tempcatid=4;
}
if(isset($_GET['home_temp']))
{
$tempcatid=5;
}
if(isset($_GET['motor_temp']))
{
$tempcatid=6;
}
if(isset($_GET['sport_temp']))
{
$tempcatid=7;
}
if(isset($_GET['toy_temp']))
{
$tempcatid=8;
}
if(isset($_GET['other_temp']))
{
$tempcatid=9;
}
$squery = "SELECT item.item_name, item.item_description, category.category_name, item.post_date,
		  ...
		  WHERE item.category_id='".$tempcatid."'";

$runsquery = mysqli_query ($connection, $squery)
or die("Error: ".mysqli_error($connection));

while($row=mysqli_fetch_row($runsquery))
{
if($row[4]!="Inactive")
{
