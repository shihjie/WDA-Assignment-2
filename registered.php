...
$countidquery= "SELECT COUNT (user_id) FROM user";
$userid="U".$countidquery;

$query = "INSERT INTO user (user_id, first_name, last_name, username, password, email, address, phone_number, rating, register_date)
		  VALUES ('".$userid."', '".$fname."', '".$lname."', '".$username."', '".$pwconfirm."', '".$email."', '".$address."', '".$number."', '".$rating."', '".$register_date."')";
		  
$query2 = "INSERT INTO recovery (user_id, secret_question, secret_answer)
